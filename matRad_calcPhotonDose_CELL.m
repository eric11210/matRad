function dij = matRad_calcPhotonDose_CELL(ct,stf,pln,cst,calcDoseDirect)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:dij.numOfBeams % loop over all beams
    ...
    for j = 1:stf(i).numOfRays % loop over all rays / for photons we only have one bixel per ray!
        ...
        [ix,rad_distancesSq,isoLatDistsX,isoLatDistsZ] = matRad_calcGeoDists_CELL(rot_coordsV, ...
