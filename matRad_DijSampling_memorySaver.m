function [ixNew,bixelDoseNew,ixTailNew,nTailPerDepth,bixelDoseTailNew,nTail,nDepth,nCore] =  matRad_DijSampling_memorySaver(ix,bixelDose,radDepthV,rad_distancesSq,sType,Param)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
