...
%% prep optimization combinations

penalty_vec = [1e3 1e4 1e5 1e6];
...
for i = 1:numel(penalty_vec)
    
    cst{25,6}.penalty = penalty_vec(i);
    fname = sprintf('penalty = 1e%d',log10(penalty_vec(i)));
    
    if penalty_vec(i) ~= 1000
