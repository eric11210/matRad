...
% load in resultGUI
load('SBRT_DAD','resultGUI')

% change initProb
resultGUI.apertureInfo.motionModel.initProb(resultGUI.apertureInfo.motionModel.indices.subPhase2PosPhase ~= 1 | resultGUI.apertureInfo.motionModel.indices.subPhase2FS ~= 3) = 0;
resultGUI.apertureInfo.motionModel.initProb = resultGUI.apertureInfo.motionModel.initProb./sum(resultGUI.apertureInfo.motionModel.initProb);
