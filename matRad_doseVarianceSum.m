...
dRawGradCell        = cell(numel(apertureInfo.beam).*numPhases.^2,1);
...
for i = 1:numel(apertureInfo.beam)
    ...
    for phase_I = 1:numPhases
        ...
        for phase_F = 1:numPhases
            ...
            dRawGradCell{(i-1).*numPhases.^2+cellInd}  = dRawGradCellTemp;
            ...
            for phase_I2 = 1:numPhases
                ...
                for subPhase_F1 = subPhases_F1
                    ...
                    for subPhase_I2 = subPhases_I2
                        ...
                        pNormGrad = pNormGradFactor.*pNormGradMat(phase_F1,phase_I2);
