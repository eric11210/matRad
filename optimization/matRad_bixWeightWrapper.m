function [apertureInfo,results] = matRad_bixWeightWrapper(apertureInfo,i,results)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% call
%   [w,bixelJApVec_vec,bixelJApVec_i,bixelJApVec_j,sumGradSq,shapeMapW,counters] = matRad_bixWeightWrapper(apertureInfo,sumGradSq,shapeMapW)
%
% input
%
% output
...
static.lastBixelIndMap          = lastFixelIndMap;
static.nextBixelIndMap          = nextFixelIndMap;
...
for phase_I = 1:apertureInfo.numPhases
    ...
    for phase_F = 1:apertureInfo.numPhases
        ...
        for j = 1:numOfShapes
            ...
            % calculate bixel weight
            tempResults = matRad_bixWeight(static,variable);
