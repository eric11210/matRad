...
for i = 1:numel(apertureInfo.beam)
    ...
    if apertureInfo.beam(i).optimizeBeam
        ...
        %now leaf pos
        indInOptVec = apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).shape(1).vectorOffset-1+[(1:apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).numOfActiveLeafPairs) ...
            apertureInfo.totalNumOfLeafPairs+(1:apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).numOfActiveLeafPairs)];
        indInBixVec = apertureInfo.beam(i).bixOffset-1+[(1:apertureInfo.beam(i).numOfActiveLeafPairs) apertureInfo.doseTotalNumOfLeafPairs+(1:apertureInfo.beam(i).numOfActiveLeafPairs)];
        ...
        g(lastOptIndTime) = g(lastOptIndTime)+(apertureInfo.beam(i).doseAngleBordersDiff.*apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).timeFacCurr) ...
            .*(-apertureInfo.beam(i).fracFromLastOpt.*apertureInfo.beam(i).timeFracFromNextOpt.*(apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).shape(1).weight./ ...
            apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).doseAngleBordersDiff).*(apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).time./apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).time.^2) ...
            +(1-apertureInfo.beam(i).fracFromLastOpt).*apertureInfo.beam(i).timeFracFromLastOpt.*(apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).shape(1).weight./ ...
            apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).doseAngleBordersDiff).*(1./apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).time)) ... 
        ...
        %now leaf pos
        indInOptVec = apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).shape(1).vectorOffset-1+[(1:apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).numOfActiveLeafPairs) ...
            apertureInfo.totalNumOfLeafPairs+(1:apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).numOfActiveLeafPairs)];
        indInBixVec = apertureInfo.beam(i).bixOffset-1+[(1:apertureInfo.beam(i).numOfActiveLeafPairs) apertureInfo.doseTotalNumOfLeafPairs+(1:apertureInfo.beam(i).numOfActiveLeafPairs)];
        ...
        g(nextOptIndTime) = g(nextOptIndTime)+(apertureInfo.beam(i).doseAngleBordersDiff.*apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).timeFacCurr) ...
            .*(apertureInfo.beam(i).fracFromLastOpt.*apertureInfo.beam(i).timeFracFromNextOpt.*(apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).shape(1).weight./ ...
            apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).doseAngleBordersDiff).*(1./apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).time) ...
            -(1-apertureInfo.beam(i).fracFromLastOpt).*apertureInfo.beam(i).timeFracFromLastOpt.*(apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).shape(1).weight./ ...
            apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).doseAngleBordersDiff).*(apertureInfo.beam(apertureInfo.beam(i).lastOptIndex).time./apertureInfo.beam(apertureInfo.beam(i).nextOptIndex).time.^2)) ...
            * apertureInfo.beam(i).shape(1).shapeMap(ix)' * bixelG(apertureInfo.beam(i).bixelIndMap(ix));
