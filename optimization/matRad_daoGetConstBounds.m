...
if ~apertureInfo.runVMAT
    ...
    if apertureInfo.propVMAT.continuousAperture
        ...
        cl_lfspd = machine.constraints.leafSpeed(1)*ones(2*numel(optInd)*apertureInfo.beam(1).numOfActiveLeafPairs,1); %Minimum leaf travel speed (mm/s)
        cu_lfspd = machine.constraints.leafSpeed(2)*ones(2*numel(optInd)*apertureInfo.beam(1).numOfActiveLeafPairs,1); %Maximum leaf travel speed (mm/s)
