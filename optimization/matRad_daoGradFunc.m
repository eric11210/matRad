...
for phase = 1:apertureInfo.numPhases
    ...
    if apertureInfo.runVMAT
        ...
        if apertureInfo.propVMAT.continuousAperture
            ...
            % sign change for left leaf position already taken care of
            ...
            for i = 1:numel(apertureInfo.beam)
                ...
                if apertureInfo.propVMAT.beam(i).DAOBeam
                    ...
                    g(offset) = g(offset)+apertureInfo.beam(i).shape{phase}(1).shapeMap(ix)' ...
                        * bixelG{phase}(apertureInfo.beam(i).bixelIndMap(ix)) ./ apertureInfo.beam(i).shape{phase}(1).jacobiScale;
                    
                    
                    %gradient wrt leaf positions
                    indInOptVec = apertureInfo.beam(i).shape{phase}(1).vectorOffset-1+[(1:apertureInfo.beam(i).numOfActiveLeafPairs) apertureInfo.totalNumOfLeafPairs+(1:apertureInfo.beam(i).numOfActiveLeafPairs)];
                    ...
                    g(indInOptVec) = g(indInOptVec)+apertureInfo.beam(i).shape{phase}(1).weight*bixelG{phase}(apertureInfo.bixelIndices(indInBixVec)) / apertureInfo.bixelWidth;
                    ...
                    g(lastDAOInd) = g(lastDAOInd)+apertureInfo.propVMAT.beam(i).fracFromLastDAO.*(apertureInfo.beam(i).time./apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).time) ...
                        *apertureInfo.beam(i).shape{phase}(1).shapeMap(ix)' * bixelG{phase}(apertureInfo.beam(i).bixelIndMap(ix))./apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).shape{phase}(1).jacobiScale;
                    ...
                    %now leaf pos
                    indInOptVec = apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).shape{phase}(1).vectorOffset-1+[(1:apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).numOfActiveLeafPairs) apertureInfo.totalNumOfLeafPairs+(1:apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).numOfActiveLeafPairs)];
                    indInBixVec = apertureInfo.beam(i).bixOffset-1+[(1:apertureInfo.beam(i).numOfActiveLeafPairs) apertureInfo.doseTotalNumOfLeafPairs+(1:apertureInfo.beam(i).numOfActiveLeafPairs)];
                    
                    g(indInOptVec) = g(indInOptVec)+apertureInfo.propVMAT.beam(i).fracFromLastDAO*apertureInfo.beam(i).shape{phase}(1).weight*bixelG{phase}(apertureInfo.bixelIndices(indInBixVec)) / apertureInfo.bixelWidth;
                    ...
                    g(lastDAOIndTime) = g(lastDAOIndTime)+(apertureInfo.propVMAT.beam(i).doseAngleBordersDiff.*apertureInfo.propVMAT.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).timeFacCurr) ...
                        .*(-apertureInfo.propVMAT.beam(i).fracFromLastDAO.*apertureInfo.propVMAT.beam(i).timeFracFromNextDAO.*(apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).shape{phase}(1).weight./apertureInfo.propVMAT.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).doseAngleBordersDiff).*(apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).time./apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).time.^2) ...
                        +(1-apertureInfo.propVMAT.beam(i).fracFromLastDAO).*apertureInfo.propVMAT.beam(i).timeFracFromLastDAO.*(apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).shape{phase}(1).weight./apertureInfo.propVMAT.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).doseAngleBordersDiff).*(1./apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).time)) ...
                        * apertureInfo.beam(i).shape{phase}(1).shapeMap(ix)' * bixelG{phase}(apertureInfo.beam(i).bixelIndMap(ix));
                    ...
                    g(nextDAOInd) = g(nextDAOInd)+(1-apertureInfo.propVMAT.beam(i).fracFromLastDAO).*(apertureInfo.beam(i).time./apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).time) ...
                        *apertureInfo.beam(i).shape{phase}(1).shapeMap(ix)' * bixelG{phase}(apertureInfo.beam(i).bixelIndMap(ix))./apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).shape{phase}(1).jacobiScale;
                    ...
                    %now leaf pos
                    indInOptVec = apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).shape{phase}(1).vectorOffset-1+[(1:apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).numOfActiveLeafPairs) apertureInfo.totalNumOfLeafPairs+(1:apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).numOfActiveLeafPairs)];
                    indInBixVec = apertureInfo.beam(i).bixOffset-1+[(1:apertureInfo.beam(i).numOfActiveLeafPairs) apertureInfo.doseTotalNumOfLeafPairs+(1:apertureInfo.beam(i).numOfActiveLeafPairs)];
                    
                    g(indInOptVec) = g(indInOptVec)+(1-apertureInfo.propVMAT.beam(i).fracFromLastDAO)*apertureInfo.beam(i).shape{phase}(1).weight*bixelG{phase}(apertureInfo.bixelIndices(indInBixVec)) / apertureInfo.bixelWidth;
                    ...
                    g(nextDAOIndTime) = g(nextDAOIndTime)+(apertureInfo.propVMAT.beam(i).doseAngleBordersDiff.*apertureInfo.propVMAT.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).timeFacCurr) ...
                        ...
                        -(1-apertureInfo.propVMAT.beam(i).fracFromLastDAO).*apertureInfo.propVMAT.beam(i).timeFracFromLastDAO.*(apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).shape{phase}(1).weight./apertureInfo.propVMAT.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).doseAngleBordersDiff).*(apertureInfo.beam(apertureInfo.propVMAT.beam(i).lastDAOIndex).time./apertureInfo.beam(apertureInfo.propVMAT.beam(i).nextDAOIndex).time.^2)) ...
                        * apertureInfo.beam(i).shape{phase}(1).shapeMap(ix)' * bixelG{phase}(apertureInfo.beam(i).bixelIndMap(ix));
        ...
        for i = 1:numel(apertureInfo.beam)
            ...
            for j = 1:apertureInfo.beam(i).numOfShapes
                g(j+offset) = apertureInfo.beam(i).shape{phase}(j).shapeMap(ix)' ...
                    * bixelG{phase}(apertureInfo.beam(i).bixelIndMap(ix))./apertureInfo.beam(i).shape{phase}(j).jacobiScale;
            end
