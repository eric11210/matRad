...
VmcInput(offset+(1:5)) = {...
    ['  :start geometry:            '                                            ]   ,...
    ['      :start ' VmcOptions.geometry.type ' geometry:    '                   ]   ,...
    ['          my name = ' VmcOptions.geometry.Geometry.Ct                      ]   ,...
    ['          method of input = ' VmcOptions.geometry.Geometry.methodOfInput   ]   ,...
    ['          phantom file    = ' VmcOptions.geometry.Geometry.CtFile          ]   ,...
    };
offset = offset+5;

if strcmp(VmcOptions.geometry.type,'def_tetra')
    VmcInput(offset+1) = {...
        ['          deformation field = ' VmcOptions.geometry.Geometry.VectorsFile  ]   ,...
        };
end
offset = offset+1;

VmcInput(offset+(1:3)) = {...
    ['      :stop ' VmcOptions.geometry.type ' geometry:     '  ]   ,...
    ['  :stop geometry:             '                           ]   ,...
    ['                              '                           ]   ...
    };
offset = offset+3;
